...
class AdminNotificationCenterController extends GetxController {
  ...
  static const List<Map<String, String>> filterDefs = [
    ...
    {'id': 'sales_order_status_unconfirmed', 'labelKey': 'طلبية جديدة'},
    {'id': 'sales_order_status_confirmed', 'labelKey': 'تم التأكيد'},
    {'id': 'sales_order_status_ready', 'labelKey': 'جاهزة'},
    {'id': 'sales_order_status_postponed', 'labelKey': 'مؤجلة'},
    {'id': 'sales_order_status_with_delivery', 'labelKey': 'مع المندوب'},
    {'id': 'sales_order_status_delivered', 'labelKey': 'تم التسليم'},
    {'id': 'sales_order_status_archived', 'labelKey': 'مؤرشفة'},
    {'id': 'sales_order_status_review', 'labelKey': 'قيد المراجعة'},
    {'id': 'sales_order_status_stuck', 'labelKey': 'متعطلة'},
    {'id': 'sales_order_status_returned', 'labelKey': 'مرتجعة'},
    {
      'id': 'sales_order_status_partial_delivered',
      'labelKey': 'تسليم جزئي',
    },
    {'id': 'sales_order_status_partial_return', 'labelKey': 'إرجاع جزئي'},
    {
      'id': 'sales_order_status_alternative_return',
      'labelKey': 'إرجاع بديل',
    },
    {'id': 'sales_order_status_canceled', 'labelKey': 'ملغاة'},
    {
