...
class ProductStockMovementModel {
  ...
  String movementTypeLabel() {
    const keys = {
      ...
      'stock_adjustment_in': 'stockMoveTypeStockAdjustmentIn',
      'stock_adjustment_out': 'stockMoveTypeStockAdjustmentOut',
      'opening_stock': 'stockMoveTypeOpeningStock',
      'cost_revaluation': 'stockMoveTypeCostRevaluation',
      'cost_initialization': 'stockMoveTypeCostInitialization',
