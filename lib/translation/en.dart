const Map<String, String> en = {
  ...
  'otpSent': 'We will send a verification code to continue',
  ...
  'quickEditProducts': 'Edit products',
  'quickEditMark': 'Today mark',
  'quickEditAction': 'Action',
  'quickEditAll': 'All',
  'quickEditUnmarkedToday': 'Unmarked today',
  'locationTableView': 'Table view',
  'locationCardsView': 'Cards view',
  ...
  'soldWithPaper': 'Sold with paper',
  'rate': 'Rate',
  'exportProductsSettingDesc': 'Export all products as a formatted Excel file',
  'importProductsSettingDesc': 'Import products from a CSV or Excel file',
  ...
  'employeePasswordChangedSuccessfully':
      'Employee password changed successfully',
  'changeEmployeePassword': 'Change password',
  ...
  'downloadStockImages': 'Download stock images',
  'stockImagesExported': 'Stock images downloaded',
  'stockImagesExportStarted':
      'Stock images ZIP is being prepared in the background. Admins will be notified when it is ready to download.',
  'stockImagesReadyTitle': 'Images file is ready',
  'stockImagesReadyMessage':
      'A ready images ZIP is available (@size). Download it?',
  'stockImagesPreparingTitle': 'Stock images are preparing',
  'stockImagesPreparingMessage': '@processed of @total products processed.',
  'stockImagesNotReadyYet': 'The images file is not ready yet.',
  'startNewExport': 'Prepare new file',
  'stockImagesExports': 'Stock image exports',
  'stockExportStatus_pending': 'Pending',
  'stockExportStatus_processing': 'Processing',
  'stockExportStatus_completed': 'Ready',
  'stockExportStatus_failed': 'Failed',
  'stockExportStatus_deleted': 'Deleted',
  'operation': 'Operation',
  'imagesAdded': 'Images added',
  'fileSize': 'File size',
  'createdAt': 'Created at',
  'completedAt': 'Ready at',
  'stockImagesSources': 'File sources',
  'stockImagesTables': 'Database link sources',
  'stockImagesSourcesPending':
      'Link sources will appear while the file is prepared.',
  'missingImages': 'Missing images',
  'deleteZipFile': 'Delete ZIP file',
  'deleteStockImagesExportTitle': 'Delete stock images file',
  'deleteStockImagesExportMessage':
      'Only the prepared ZIP copy will be deleted. Original images and stock data will not be affected.',
  'stockImagesExportDeleted': 'ZIP file deleted successfully',
  'download': 'Download',
  'openFile': 'Open file',
...
// Customer Details
  ...
  'partnershipSectionPermission': 'Partnership Section',
  'salesDailyCloseReviewPermission': 'Sales Daily Close Review',
  'salesCancelClosedReviewPermission': 'Sales Cancel Closed Review',
  'adminOnlyPermission': 'Admin-only permission',
  ...
  'ledgerPrivate': 'Private',
  'ledgerCustomer': 'Customer',
  'ledgerSupplier': 'Supplier',
  'ledgerMoveToPrivate': 'Move to private debts',
  'ledgerRemoveFromPrivate': 'Remove from private debts',
  'ledgerMovedToPrivate': 'Moved to private debts',
  'ledgerRemovedFromPrivate': 'Removed from private debts',
  ...
  'ledgerBalanceScope': 'Balance calculation',
  'ledgerBalanceScopeFull': 'Full account balance',
  'ledgerBalanceScopePeriod': 'Period balance',
  ...
  'salesOrderStuckReasonHint':
      'Explain what stopped the order and what is needed to resolve it',
  'salesOrderStuckReasonRequired': 'A reason is required',
  'salesOrderStuckType': 'Issue type *',
  'salesOrderStuckType_customer': 'Customer',
  'salesOrderStuckType_address': 'Address',
  'salesOrderStuckType_phone': 'Phone number',
  'salesOrderStuckType_delivery': 'Delivery carrier or method',
  'salesOrderStuckType_collection': 'Payment collection',
  'salesOrderStuckType_stock': 'Stock',
  'salesOrderStuckType_other': 'Other',
  'salesOrderStuckAssignedTo': 'Responsible employee',
  'salesOrderStuckAssignCurrent': 'Me — current user',
  'salesOrderStuckAddFollowUp': 'Add follow-up date (optional)',
  'salesOrderStuckRemoveFollowUp': 'Remove follow-up date',
  'salesOrderStuckFollowUpFuture': 'The follow-up date must be in the future',
  'salesOrderStuckTypeValue': 'Issue type: @type',
  'salesOrderStuckAssignedValue': 'Responsible employee: @name',
  'salesOrderStuckFollowUpValue': 'Follow up at: @date',
  'salesOrderResolveTargetStatus': 'Status after resolution *',
  'salesOrderResolutionNote': 'How was the issue resolved?',
  'salesOrderResolutionNoteHint':
      'Describe the action taken and the resulting outcome',
  'salesOrderResolutionNoteRequired': 'A resolution note is required',
  ...
  'minimumSale': 'Minimum sale price',
  ...
  'extraLaravelFields': 'Extra fields (minimum sale price, rotation number)',
  ...
  'listPriceField': 'Backup price',
  'rotationNumberField': 'Rotation number',
  'rotationDateField': 'Rotation date',
  'stockLocationMinStock': 'Minimum stock',
  'rotationDateHint': 'Number',
  ...
  'addStockQuick': 'Purchase this product',
  'stockAdjustment': 'Stock adjustment',
  'stockAdjustmentReasonRequired': 'A stock adjustment reason is required',
  'stockPurchased': 'Purchased',
  'stockSold': 'Sold',
  'stockSalesReturned': 'Sales returns',
  'stockPurchaseReturned': 'Purchase returns',
  ...
  'stockMoveTypePurchaseReturn': 'Purchase return',
  'stockMoveTypePurchaseReturnCancel': 'Purchase return cancelled',
  'stockMoveTypeMaintenance': 'Maintenance',
  ...
  'stockMoveTypeSalesReturn': 'Sales return',
  'stockMoveTypeSalesReturnCancel': 'Sales return cancelled',
  'stockMoveTypeManualAdd': 'Manual add',
  'stockMoveTypeManualSet': 'Manual remove',
  'stockMoveTypeStockAdjustmentIn': 'Stock adjustment - increase',
  'stockMoveTypeStockAdjustmentOut': 'Stock adjustment - decrease',
  'stockMoveTypeOpeningStock': 'Opening stock',
  'stockMoveTypeCostRevaluation': 'Inventory cost revaluation',
  'stockMoveTypeCostInitialization': 'Missing inventory cost entry',
  ...
  'stockMoveColDocument': 'Document',
  'stockDocumentDetails': 'Document details',
  'stockDocumentParty': 'Customer or supplier',
  'stockDocumentStatus': 'Status',
  'stockDocumentSource': 'Source document',
  'stockDocumentPaid': 'Paid',
  'stockDocumentRemaining': 'Remaining',
  'stockDocumentBox': 'Cashbox',
  'stockDocumentReason': 'Reason',
  ...
  'productRotationDate': 'Product Rotation Number',
  ...
  'manageEmployeePointsAction': 'Add or deduct points',
  'pointsManualEntry': 'Enter points manually',
  'pointsEvidenceTakePhoto': 'Take an evidence photo',
  'pointsEvidenceUploading': 'Uploading image...',
  'pointsSaveReady': 'Data and image will be saved with the points entry',
  'pointsSaving': 'Saving points entry...',
  'pointsSavingWithImage': 'Uploading image and saving points entry...',
  'retakePhoto': 'Retake',
  ...
  'instantSaleTierPriceSource': 'Quantity price',
  'instantSaleCustomPriceSource': 'Custom price',
  'instantSaleVariantWholesalePriceSource': 'Variant wholesale price',
  'instantSaleVariantRetailPriceSource': 'Variant retail price',
  ...
  'autoSavedSaleDrafts': 'My auto-saved drafts',
  'autoSavedSaleDraftDefaultLabel': 'Auto-saved sale draft',
  'autoSavedDraftCancelTitle': 'Delete auto-saved draft',
  'autoSavedDraftCancelMessage': 'Delete this auto-saved draft?',
  ...
  'instantSaleAutoSavedSuspended': 'Draft auto-saved',
  ...
  'passwordResetOtpDeliverySetting': 'Password reset code delivery',
  'passwordResetOtpDeliverySettingDesc':
      'Choose whether the code goes by email, to admin, or by SMS when available',
  'passwordResetOtpDeliveryEmail': 'User email',
  'passwordResetOtpDeliveryEmailDesc':
      'Send the reset code to the user email as currently configured',
  'passwordResetOtpDeliveryAdmin': 'Admin notification',
  'passwordResetOtpDeliveryAdminDesc':
      'Send the code to admin so they can give it to the employee manually',
  'passwordResetOtpDeliverySms': 'SMS',
  'passwordResetOtpDeliverySmsDesc':
      'Send the code to the user phone when SMS settings are active',
  'passwordResetCodesReportTitle': 'Password reset code log',
  'passwordResetCodesReportDesc':
      'See who requested a code and whether it is active, used, or expired',
  'passwordResetCodesReportEmpty': 'No reset codes for this filter',
  'passwordResetStatus_all': 'All',
  'passwordResetStatus_active': 'Active',
  'passwordResetStatus_used': 'Used',
  'passwordResetStatus_expired': 'Expired',
  'passwordResetRequestedAt': 'Requested',
  'passwordResetExpiresAt': 'Expires',
  'passwordResetUsedAt': 'Used',
  ...
  'appVersionReportTitle': 'App version report',
  'appVersionReportDesc': 'See app versions currently used by staff devices',
  'appVersionReportSummary': 'Version summary',
  'appVersionReportDevices': 'Recent devices',
  'appVersionReportEmpty': 'No data yet',
  'appVersionReportUsers': 'user(s)',
  'appVersionReportDevicesShort': 'device(s)',
  'appVersionReportLatestOnly': 'Latest 3 versions per platform',
  'appVersionReportPlatforms': 'platform(s)',
  'appVersionReportVersions': 'version(s)',
  'appPlatformAndroid': 'Android',
  'appPlatformIos': 'iOS',
  'appPlatformWindows': 'Windows',
  'loading': 'Loading',
  'customizeDashboard': 'Customize dashboard',
  'resetDashboardSections': 'Show all',
  ...
  'smartHomeAddSelected': 'Continue with selected (@count)',
  'smartHomeDevicesPaired': 'Added @added of @total devices',
  'smartHomePairingPreparing': 'Preparing pairing',
  'smartHomePairingTuya': 'Tuya is pairing the device',
  'smartHomePairingSaving': 'Paired, saving the device',
  'smartHomePairingComplete': 'Device added successfully',
  'smartHomeFilters': 'Display filters',
  ...
  'smartHomeDeviceDetails': 'Device details',
  'smartHomeDeviceName': 'Device name',
  ...
  'smartHomeSelectLocation': 'Select location',
  'smartHomeAddLocation': 'Add location',
  'smartHomeLocationName': 'Location name',
  'smartHomeLocationNameRequired': 'Location name is required',
  'smartHomeHomeType': 'Home',
  'smartHomeCompanyType': 'Company',
  'smartHomeUnassignedDevices': 'Unassigned devices',
  'smartHomeAllDevices': 'All',
  'smartHomeRoomName': 'Room name',
  'smartHomeRoomNameRequired': 'Room name is required',
  'smartHomeRenameRoom': 'Rename room',
  'smartHomeDeleteRoom': 'Delete room',
  'smartHomeDeleteRoomConfirm':
      'Only the room will be deleted. Devices will stay in the location without a room.',
  'smartHomeLocationOnly': 'In location, no room',
  'smartHomeMoveDevice': 'Move device',
  'smartHomeDeviceMoved': 'Device moved',
  'smartHomeManageChannels': 'Manage switches',
  'smartHomeHideChannel': 'Hide switch',
  'smartHomeShowChannel': 'Show switch',
  'smartHomeTimers': 'Timers',
  'smartHomeSchedules': 'Schedules',
  'smartHomeSchedule': 'New schedule',
  'smartHomeAddSchedule': 'Add schedule',
  'smartHomeEditSchedule': 'Edit schedule',
  'smartHomeNoSchedules': 'No schedules for this device',
  'smartHomeScheduleActive': 'Enabled',
  'smartHomeScheduleInactive': 'Paused',
  'smartHomeScheduleCompleted': 'Completed',
  'smartHomeScheduleNextRun': 'Next run',
  'smartHomeScheduleNearestTime': 'At the nearest upcoming time',
  'smartHomeScheduleNoSwitches': 'This device has no schedulable switches',
  'smartHomeScheduleName': 'Schedule name',
  'smartHomeScheduleSwitch': 'Device or switch',
  'smartHomeScheduleEnabled': 'Schedule enabled',
  'smartHomeScheduleSaveFailed': 'Could not save the schedule in Tuya',
  'smartHomeScheduleDeleteFailed': 'Could not delete the schedule from Tuya',
  'smartHomeScheduleDeleteConfirm': 'Delete this schedule?',
  'smartHomeRepeat': 'Repeat',
  'smartHomeTurnOn': 'Turn on',
  'smartHomeTurnOff': 'Turn off',
  'weekday_mon': 'Mon',
  'weekday_tue': 'Tue',
  'weekday_wed': 'Wed',
  'weekday_thu': 'Thu',
  ...
  'weekday_sat': 'Sat',
  'weekday_sun': 'Sun',
  'smartHomeAdvancedControls': 'Advanced controls',
  'smartHomeDeviceSettings': 'Device settings',
  'smartHomeEditValue': 'Edit value',
  ...
  'smartHomeDpsCode': 'DPS code',
  'smartHomeDeviceSpecs': 'Device specs',
  'smartHomeCategory': 'Category',
  'smartHomeProductName': 'Product name',
  'smartHomeProtocol': 'Protocol',
  'smartHomeModel': 'Model',
  'smartHomeManufacturer': 'Manufacturer',
