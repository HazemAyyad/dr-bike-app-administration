...
import '../features/admin/notifications/presentation/bindings/admin_notification_settings_binding.dart';
import '../features/admin/notifications/presentation/views/admin_notification_settings_screen.dart';
...
import '../features/admin/employee_section/presentation/views/employee_points_settings_screen.dart';
...
class AppPages {
  ...
  static final List<GetPage> pages = [
    ...
    GetPage(
      name: AppRoutes.NOTIFICATIONSETTINGSCENTER,
      page: () => const AdminNotificationSettingsScreen(),
      binding: AdminNotificationSettingsBinding(),
      transition: _transitionFadeIn,
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.ADDEDITADMINSCREEN,
      page: () => const AddEditAdminScreen(),
      binding: EmployeeSectionBinding(),
      transition: Get.locale == const Locale('ar')
          ? _transitionLeftToRight
          : _transitionRightToLeft,
    ...
    GetPage(
      name: AppRoutes.EMPLOYEEPOINTSSETTINGSSCREEN,
      page: () => const EmployeePointsSettingsScreen(),
      binding: EmployeeSectionBinding(),
      transition: _transitionFadeIn,
    ),
    GetPage(
